...
def test_llama_attention(
    ...
    output5 = builder.reshape(output3, (1, 64, 32, 128))
    ...
    output51 = builder.reshape(output49, (1, 64, 32, 128))
    ...
    # output95 = builder.reshape(output93, (1, 64, 32, 128))
    ...
    # output111 = builder.reshape(output109, (64, 4096))

...
func.func @gather_with_shard_on_op_result(
    ...
    %arg1: tensor<4x56x56x96xbf16> {sdy.sharding = #sdy.sharding<@mesh, [{"batch"}, {}, {}, {}]>},
    %arg2: tensor<56x2xi64>
) -> tensor<1x56x56x96xbf16> {
  %0 = stablehlo.add %arg0, %arg1
      {sdy.sharding = #sdy.sharding_per_value<[<@mesh, [{"batch"}, {}, {}, {}]>]>}
      : (tensor<4x56x56x96xbf16>, tensor<4x56x56x96xbf16>) -> tensor<4x56x56x96xbf16>
  %1 = "stablehlo.gather"(%0, %arg2)
      <{
        ...
        slice_sizes = array<i64: 1, 1, 56, 96>
      }>
      : (tensor<4x56x56x96xbf16>, tensor<56x2xi64>) -> tensor<1x56x56x96xbf16>
  return %1 : tensor<1x56x56x96xbf16>
}

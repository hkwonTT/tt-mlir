...
module @point_to_point_provided_output_tensor_different_shape attributes {} {
  func.func public @main(%arg0: tensor<4096x16384xf32, #ttnn_layout1>) -> (tensor<4096x8192xf32, #ttnn_layout2> {}) {
    ...
    %2 = "ttnn.point_to_point"(%arg0, %1) <{receive_coord = #ttnn.mesh_coordinate<0x1>, send_coord = #ttnn.mesh_coordinate<0x0>}> : (tensor<4096x16384xf32, #ttnn_layout1>, tensor<4096x8192xf32, #ttnn_layout2>) -> tensor<4096x8192xf32, #ttnn_layout2>
...
module @point_to_point_provided_output_tensor_different_element_type attributes {} {
  func.func public @main(%arg0: tensor<4096x16384xf32, #ttnn_layout1>) -> (tensor<4096x16384xi32, #ttnn_layout2> {}) {
    ...
    %2 = "ttnn.point_to_point"(%arg0, %1) <{receive_coord = #ttnn.mesh_coordinate<0x1>, send_coord = #ttnn.mesh_coordinate<0x0>}> : (tensor<4096x16384xf32, #ttnn_layout1>, tensor<4096x16384xf16, #ttnn_layout2>) -> tensor<4096x16384xf16, #ttnn_layout2>
